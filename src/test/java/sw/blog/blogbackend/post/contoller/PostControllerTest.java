package sw.blog.blogbackend.post.contoller;
...
public class PostControllerTest {
    ...
    void whenGetPosts_thenReturnPostList() throws Exception {
        PostListResponse post1 = PostListResponse.builder()
                .postId(1L).title("P1").content("C1").category("Java").build();
        PostListResponse post2 = PostListResponse.builder()
                .postId(2L).title("P2").content("C2").category("String").build();
        List<PostListResponse> mockPosts = Arrays.asList(post1, post2);
